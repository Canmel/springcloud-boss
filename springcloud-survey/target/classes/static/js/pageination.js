var pageination='<script type="text/x-template" id="pageination">\n' +
    ...
    '            <button @click="pageUp(0)" class="pagination_page btn-rounded outline" :class="startDisabled?\'disabled\':\'\'">首页</button>\n' +
    '            <button @click="pageUp(1)" class="pagination_page btn-rounded outline" :class="startDisabled?\'disabled\':\'\'">上一页</button>\n' +
    '            <button class="pagination_page btn-rounded " :class="item==pageinationCurrentPage?\'pagination_page_active\':\'\'"\n' +
    '                 v-for="item in pageinationLength" @click="jump(item)">\n' +
    '                {{item}}\n' +
    '            </button>\n' +
    '            <button @click="pageDown(1)" class="pagination_page btn-rounded outline" :class="endDisabled?\'disabled\':\'\'">下一页</button>\n' +
    '            <button @click="pageDown(0)" class="pagination_page btn-rounded outline" :class="endDisabled?\'disabled\':\'\'">\n' +
    '                尾页\n' +
    '            </button>\n' +
    '        </div>\n' +
    '    </div>\n' +
