...
if(!window.__b_release_mode){
    tsdp_api_add_js_scripts('head',
        'js/src/tinySDP/src/headers/tsdp_header_A.js',
        'js/src/tinySDP/src/headers/tsdp_header_C.js',
        'js/src/tinySDP/src/headers/tsdp_header_M.js',
        'js/src/tinySDP/src/headers/tsdp_header_O.js',
        'js/src/tinySDP/src/headers/tsdp_header_Str.js', // B, E, I, K, P, R, S, T, U, Z
        'js/src/tinySDP/src/headers/tsdp_header_V.js'
    );
}