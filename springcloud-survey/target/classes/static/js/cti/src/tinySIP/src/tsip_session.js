...
if(!window.__b_release_mode){
    ...
    'js/src/tinySIP/src/api/tsip_api_common.js',
    'js/src/tinySIP/src/api/tsip_api_info.js',
    'js/src/tinySIP/src/api/tsip_api_invite.js',
    'js/src/tinySIP/src/api/tsip_api_message.js',
    'js/src/tinySIP/src/api/tsip_api_options.js',
    'js/src/tinySIP/src/api/tsip_api_publish.js',
    'js/src/tinySIP/src/api/tsip_api_register.js',
    'js/src/tinySIP/src/api/tsip_api_subscribe.js'
    );
}