...
public enum DocumentStatus implements MyEnum {
    INVALID(0, "无效"), CREATED(1, "创建"),COLLECTING(2, "开始收集");

    private String name;
    private Integer value;

    DocumentStatus(Integer value, String name) {
        this.name = name;
        this.value = value;
    }
    ...
    public static DocumentStatus getEnumByValue(Integer value) {
        for (DocumentStatus resourceStatus : DocumentStatus.values()) {
