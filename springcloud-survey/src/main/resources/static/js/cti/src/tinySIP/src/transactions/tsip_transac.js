...
if(!window.__b_release_mode){
    tsip_api_add_js_scripts('head',
     'js/src/tinySIP/src/transactions/tsip_transac_ict.js',
     'js/src/tinySIP/src/transactions/tsip_transac_ist.js',
     'js/src/tinySIP/src/transactions/tsip_transac_layer.js',
     'js/src/tinySIP/src/transactions/tsip_transac_nict.js',
     'js/src/tinySIP/src/transactions/tsip_transac_nist.js'
    );
}
