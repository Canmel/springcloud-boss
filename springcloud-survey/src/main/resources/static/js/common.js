var zg,
    appid = getParamByName('appid') || 2696647174, // 必填，应用id，请从 即构管理控制台-https://console.zego.im/acount/register 或邮件中获取
    appSigin = '0x2e,0x80,0x69,0xdb,0x19,0x1a,0xbd,0x14,0x99,0xea,0xa4,0x5a,0xf8,0xcc,0x6f,0xfc,0x2f,0x83,0x4a,0x01,0x43,0x1c,0x5d,0xc5,0x4c,0x28,0x28,0x59,0xa6,0x2d,0x53,0x2b', // appSigin为即构给客户分配的秘钥，请勿泄漏；（测试环境下是生成token的密码，必填，正式环境需要放到服务端）
    _config = {
        appid: appid * 1,
...
function desc() {
    addCssByLink('/survey/css/desc.css');

    loadJs('/survey/js/desc.js', function () {
...
(function() {
    $.MsgBox = {
        ...
        Confirm: function(title, msg, callback, noback) {
