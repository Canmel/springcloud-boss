...
if(!window.__b_release_mode){
    tsip_api_add_js_scripts('head',
        'js/src/tinySIP/src/headers/tsip_header_Int.js', // 'Content-Length', 'Expires', 'Max-Forwards', 'Min_Expires', 'Min-SE', 'RSeq'
        'js/src/tinySIP/src/headers/tsip_header_NameAddr.js', // 'From', 'To', 'Refer-To', 'Referred-By'
        // 'js/src/tinySIP/src/headers/tsip_header_NameAddrArray.js', #include_in<tsip_header_NameAddr.js> // 'P-Asserted-Identity', 'P-Associated-URI', 'P-Preferred-Identity', 'Path', 'Record-Route', 'Route', 'Service-Route'
        'js/src/tinySIP/src/headers/tsip_header_Str.js', // Call-ID, 'Date', 'Event', 'P-Access-Network-Info', 'P-Charging-Function-Addresses', 'Server', SIP-ETag, SIP-If-Match, User-Agent, Warning, Dummy
        'js/src/tinySIP/src/headers/tsip_header_StrArray.js', // 'Allow', 'Allow-Events', 'Privacy', 'Require', 'Supported'

        'js/src/tinySIP/src/headers/tsip_header_Authorization.js',
        'js/src/tinySIP/src/headers/tsip_header_Contact.js',
        'js/src/tinySIP/src/headers/tsip_header_Content_Type.js',
        'js/src/tinySIP/src/headers/tsip_header_CSeq.js',
        'js/src/tinySIP/src/headers/tsip_header_RAck.js',
        'js/src/tinySIP/src/headers/tsip_header_Refer_Sub.js',
        'js/src/tinySIP/src/headers/tsip_header_Session_Expires.js',
        'js/src/tinySIP/src/headers/tsip_header_Subscription_State.js',
        'js/src/tinySIP/src/headers/tsip_header_Via.js',
        'js/src/tinySIP/src/headers/tsip_header_WWW_Authenticate.js'
    );
}