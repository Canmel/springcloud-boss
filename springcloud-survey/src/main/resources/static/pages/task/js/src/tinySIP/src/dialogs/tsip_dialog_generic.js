...
if(!window.__b_release_mode){
    tsip_api_add_js_scripts('head',
        'js/src/tinySIP/src/dialogs/tsip_dialog_generic__message.js',
        'js/src/tinySIP/src/dialogs/tsip_dialog_generic__publish.js',
        'js/src/tinySIP/src/dialogs/tsip_dialog_generic__subscribe.js'
    );
}
