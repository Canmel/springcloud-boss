...
public class LhzxHttpClientUtil {
    ...
    public static void main(String[] args) {
        ...
        String user = "tztjxx";//分配的接口调用用户帐号 username
        String siid = "TZSTJJXXC";//客户编号  yoursiid
        String secretKey = "TZtjxx88";// 用户接口密钥
        ...
        String mobile = "18357162602";//群发用英文逗号分隔133xxxxbbbb,135xxxxbbbb
