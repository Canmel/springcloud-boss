...
public class MysqlGenerator {
    public static String CODE_FACTORY_OUT_PATH = "./springcloud-realname/src/main/java/com/camel/realname";
    public static String XML_FACTORY_OUT_PATH = "./springcloud-realname/src/main/resources/";
    ...
    public static void main(String[] args) {
        ...
        // 指定表名
        strategyConfig.setInclude(new String[] {"apply_number"});
        strategyConfig
                .setCapitalMode(true)
