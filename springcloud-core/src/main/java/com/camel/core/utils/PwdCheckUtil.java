...
public class PwdCheckUtil {
    ...
    public static void main(String[] args) {
        System.out.println(checkSequentialSameChars("AAAAA", 5));
        System.out.println(checkSequentialChars("Abcks", 3, true));
        System.out.println(checkKeyboardSlantSite("Qaz", 3, false));
        System.out.println(checkLateralKeyboardSite("qwer", 3, false));
    }
    ...
    public static boolean checkPasswordLength(String password, String minNum, String maxNum) {
        ...
        if (maxNum==null || "".equals(maxNum))  {
            minNum = (maxNum==null || "".equals(maxNum)) == true ? "0":minNum;
