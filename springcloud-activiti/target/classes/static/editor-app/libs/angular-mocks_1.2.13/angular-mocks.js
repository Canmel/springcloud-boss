 ...
 * to attendance whether a certain request has been sent or not, or alternatively just let the
 ...
 * easy to inject $httpBackend mock (which has the same API as $httpBackend) and use it to attendance
