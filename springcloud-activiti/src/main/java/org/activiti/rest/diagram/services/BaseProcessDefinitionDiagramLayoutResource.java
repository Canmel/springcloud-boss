...
public class BaseProcessDefinitionDiagramLayoutResource {
    ...
    public static final String SEQ_SEQUENTIAL = "sequential";
    public static final String MULTIINSTANCE = "multiInstance";
    public static final String PARALLEL = "parallel";
    public static final String CALLACTIVITY_STR = "callActivity";
    ...
    private void getActivity(String processInstanceId, ActivityImpl activity, ArrayNode activityArray,
        ...
        if (multiInstance != null) {
            if (!SEQ_SEQUENTIAL.equals(multiInstance)) {
        ...
        for (PvmTransition sequenceFlow : activity.getOutgoingTransitions()) {
            ...
            for (int i = 0; i < waypoints.size(); i += TWO_NUM) {
        ...
        if (CALLACTIVITY_STR.equals(properties.get(TYPE_STR))) {
