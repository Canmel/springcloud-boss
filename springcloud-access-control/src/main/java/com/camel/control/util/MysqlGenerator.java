package com.camel.control.util;
...
public class MysqlGenerator {
    public static String CODE_FACTORY_OUT_PATH = "./springcloud-access-control/src/main/java/com/camel/control";
    public static String XML_FACTORY_OUT_PATH = "./springcloud-access-control/src/main/resources/";
    ...
    public static void main(String[] args) {
        ...
        String dbUrl = "jdbc:mysql://127.0.0.1:3306/dw_interviewer?useSSL=false&allowMultiQueries=true&serverTimezone=GMT%2B8";
        ...
        // 指定表名
        strategyConfig.setInclude(new String[] {"d_record"});
        strategyConfig
                .setCapitalMode(true)
