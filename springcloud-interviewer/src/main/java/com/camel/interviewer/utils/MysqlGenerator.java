...
public class MysqlGenerator {
    public static String CODE_FACTORY_OUT_PATH = "./springcloud-interviewer/src/main/java/com/camel/interviewer";
    public static String XML_FACTORY_OUT_PATH = "./springcloud-interviewer/src/main/resources/";
    ...
    public static void main(String[] args) {
        ...
        // 指定表名
        strategyConfig.setInclude(new String[] {"wx_subscibe"});
        strategyConfig
                .setCapitalMode(true)
        ...
        new AutoGenerator().setGlobalConfig(config)
                ...
                .setPackageInfo(
                        new PackageConfig()
                                .setParent("com.camel.interviewer")
