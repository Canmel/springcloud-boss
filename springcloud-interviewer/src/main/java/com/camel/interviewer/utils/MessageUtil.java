...
import com.camel.interviewer.entity.wx.*;
...
public class MessageUtil {
    ...
    public static String subscribeForImageText(String toUserName,String fromUserName){
        ...
        article.setTitle("欢迎关注赛炜调查");
        article.setDescription("进行操作之前请先完善个人资料");
        article.setPicUrl("https://diaocha.svdata.cn/viewer/wx/img/share04.png");
        article.setUrl("https://open.weixin.qq.com/connect/oauth2/authorize?appid="+ appId +"&redirect_uri=https://diaocha.svdata.cn/viewer/view/profile&response_type=code&scope=snsapi_base&state=STATE#wechat_redirect");
